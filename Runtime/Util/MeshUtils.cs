...
namespace BSPImporter
{
    ...
    public static class MeshUtils
    {
        ...
        public static Mesh CreateFaceMesh(BSP bsp, Face face, Vector2 dims, Vector2 lightmapPos, int curveTessellationLevel)
        {
            Mesh mesh = null;
            ...
            if (mesh != null)
            {
                ...
                mesh.CalculateUV2s(textureInfo, lightmapPos);
                mesh.NegateVs();
            }
            return mesh;
        }
